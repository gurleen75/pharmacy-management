...
<body>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>PMS</span><br>Pharmacy Management System</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
        ...
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="total__box text-center">
                                    <h1>
                                        <?php
                                            $query = "SELECT COUNT(*) totalMedicines FROM medicines;";
                                                $result = mysqli_query( $connection, $query );
                                                $totalPharmacist = mysqli_fetch_assoc( $result );
                                                echo $totalPharmacist['totalMedicines'];
                                            ?>
            ...
            <div class="medicine">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            <td><?php printf( "%s", $medicine['medname'] );?></td>
                                            <td><?php printf( "%s", $medicine['batch_no'] );?></td>
                                            <td><?php printf( "%s", $medicine['cost'] );?></td>
                                            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                                                <!-- For Admin, Manager, Pharmacist-->
                                                <td><?php printf( "<a href='index.php?action=editMedicine&id=%s'><i class='fas fa-edit'></i></a>", $medicine['id'] )?></td>
                                                <td><?php printf( "<a class='delete' href='index.php?action=deleteMedicine&id=%s'><i class='fas fa-trash'></i></a>", $medicine['id'] )?></td>
                                            <?php }?>
                                        </tr>
                ...
                <?php if ( 'editMedicine' == $action ) {
                        ...
                        $selectMedicine = "SELECT * FROM medicines WHERE id='{$medicineID}'";
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" ></i>
                                            <input type="text" name="medname" placeholder="Medicine Name" value="<?php echo $medicine['medname']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" ></i>
                                            <input type="text" name="batch_no" placeholder="Batch Number" value="<?php echo $medicine['batch_no']; ?>" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" ></i>
                                            <input type="text" name="cost" placeholder="Cost" value="<?php echo $medicine['cost']; ?>" required>
                                        </label>
                                    </div>
                ...
                <?php if ( 'deleteMedicine' == $action ) {
                        $medicineID = $_REQUEST['id'];
                        $deleteMedicine = "DELETE FROM medicines WHERE id ='{$medicineID}'";
